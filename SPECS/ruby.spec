...
Patch15: rubygem-net-imap-0.4.24-DoS-via-crafted-IMAP-responses-CVE-2026-42245.patch
# Test commits from PR were dropped. The gem does not have tests in the ruby tar.
# Backported from
# https://github.com/ruby/net-imap/commit/705aa59
# https://github.com/ruby/net-imap/commit/038ae35
Patch16: rubygem-net-imap-0.4.24-Information-disclosure-via-MITM-attack-bypassing-TLS-2026-42246.patch
...
Patch17: rubygem-net-imap-0.4.24-Command-Injection-via-Symbol-Arguments-CVE-2026-42258.patch
...
# Use `%%patch -P N` form for better compatibility. `%%patch N` is available on
# RPM version >= 4.18 and `%%patchN` was deprecated.
# https://github.com/rpm-software-management/rpm/blob/656fe42af1d497c35769c740fcc98950e1455bad/docs/manual/spec.md?plain=1#L515
%patch -P 0 -p1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
ln -s %{gem_libdir irb}/irb %{buildroot}%{ruby_libdir}/irb
